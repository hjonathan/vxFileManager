<template>
  <li class="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow-sm hover:bg-gray-100 hover:cursor-pointer">
    <div class="flex flex-1 flex-col p-8 items-center">
      <slot name="image" />
      <h3 class="mt-6 text-sm font-medium text-gray-900">{{ data.name }}</h3>
      <dl class="mt-1 flex grow flex-col justify-between">
        <dt class="sr-only">Title</dt>
        <dd class="text-sm text-gray-500">{{ data.description }}</dd>
