<template>
    <div class="flex items-center justify-center">
        <!-- <FolderIcon v-if="item.type === 'Directory'" class="size-8 flex-none bg-gray-50" /> -->
        <svg v-if="item.type === 'Directory'" width="53px" height="52px" viewBox="0 0 53 39" version="1.1"
            ...
            <path
                ...
                stroke="none" stroke-width="0" class="svg-color-theme"></path>
            <path
                d="M48.03125,6.5 L29.790833,6.5 C28.7431613,6.5 27.7373076,6.08896217 26.9894703,5.35523504 L22.6980297,1.14476496 C21.9501924,0.41103783 20.9443387,-6.36543387e-16 19.896667,0 L4.96875,0 L4.96875,0 C2.22455078,0 0,2.18257812 0,4.875 L0,34.125 C0,36.8174219 2.22455078,39 4.96875,39 L48.03125,39 C50.7754492,39 53,36.8174219 53,34.125 L53,11.375 C53,8.68257813 50.7754492,6.5 48.03125,6.5 Z"
                fill="black" fill-opacity="0.2" stroke="none" stroke-width="0"></path>
            <path
                ...
                stroke-width="2" fill="green" class="svg-color-theme"></path>
        </svg>
        ...
        <div v-else class="flex items-center justify-center pr-2"><span
                ...
                {{ extension }}
            </span> <svg width="38px" height="51px" fill="currentColor" viewBox="0 0 38 51" version="1.1"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                class="vue-feather dark:text-gray-200 text-gray-100">
                <path
