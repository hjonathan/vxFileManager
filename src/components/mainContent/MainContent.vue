<template>
  ...
  <main class="lg:pr-96">
    ...
    <!--
          ...
          -->
    <!-- <div
          class="absolute right-0 z-10 mt-2.5 w-40 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-hidden"
          ...
          <a href="#" class="block px-3 py-1 text-sm/6 text-gray-900" role="menuitem" tabindex="-1"
            id="sort-menu-item-1">Date updated</a>
          <a href="#" class="block px-3 py-1 text-sm/6 text-gray-900" role="menuitem" tabindex="-1"
            id="sort-menu-item-2">Environment</a>
        </div>
      </div>
    </header> -->

    <!-- Deployment list -->
    <ul role="list" class="divide-y divide-gray-200 hover:bg-gray-100">
      <li class="relative flex items-center space-x-4 px-4 py-4 sm:px-6 lg:px-8">
        <div class="min-w-0 flex-auto">
          <div class="flex items-center gap-x-3">
            <div class="flex-none rounded-full bg-gray-100 p-1 text-gray-500">
    ...
    <StackedList v-if="typeView === 'stacked'" v-model:selectMode="selectMode" />
